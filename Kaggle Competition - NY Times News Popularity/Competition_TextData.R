...
#HeadlineWordsTrain$PubDate = as.numeric(strptime(NewsTrain$PubDate, format="%Y-%m-%d %H:%M:%S"))
#HeadlineWordsTrain$PubDate = NewsTrain$PubDate 
...
#HeadlineWordsTest$PubDate = as.numeric(strptime(NewsTest$PubDate, format="%Y-%m-%d %H:%M:%S"))
#HeadlineWordsTest$PubDate = NewsTest$PubDate 
